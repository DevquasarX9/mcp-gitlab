...
- Intelligence: `gitlab_summarize_project_status`, `gitlab_stale_merge_request_cleanup`, `gitlab_flaky_ci_triage`, `gitlab_release_readiness_check`, `gitlab_review_merge_request_risks`, `gitlab_generate_release_notes`
